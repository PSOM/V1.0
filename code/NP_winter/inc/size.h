...
! 2km resolution domain
! INTEGER, PARAMETER                 :: NI=96, NJ=160,NK=32,ngrid=5,maxout=626736, maxint=561720,int1=491520

! 1km resolution domain
! INTEGER, PARAMETER                 :: NI=112, NJ=304, NK=32, ngrid=5, maxout=1374828, maxint=1245146, int1=1089536

! 750m resolution
! INTEGER, PARAMETER                  :: NI=160, NJ=416, NK=32, ngrid=5, maxout=2665296, maxint=2434120, int1=2129920

! 500m resolution domain
 INTEGER, PARAMETER                 :: NI=224, NJ=608, NK=32, ngrid=5, maxout=5421072, maxint=4980584, int1=4358144
