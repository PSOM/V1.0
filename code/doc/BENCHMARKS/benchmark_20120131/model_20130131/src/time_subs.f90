...
function dawson (const,daw0,r0,xi0,xi)
 ...
 IMPLICIT NONE
 REAL(kind=rc_kind) ::  dawson,const,daw0,r0,xi0,xi,daw,s15aff
...
USE mod_param
 IMPLICIT NONE
 REAL(kind=rc_kind),  PARAMETER :: xilim=3.0d0
 REAL(kind=rc_kind) ::  errfun,const,erf0,r0,xi0,xi,erf,s15aef,s15adf,hh0,hh
 INTEGER :: i
...
! Returns Dawson's integral for any REAL(kind=rc_kind) :: x.
...
!Internal arithmetic will be done in REAL(kind=rc_kind), 
