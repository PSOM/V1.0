subroutine writeisopycnal(sigma,counter_2d,n)
  !     ------------------------------------------------------------------
USE header,ONLY : NI,NJ,NK,ntr,DL,LEN,stressx,T,rho,xc,yc,zc,zf,vor,strain,shear,freqN2,nconsume,time_seconds,dirout,rc_kind
