...
! =====================================================================================================     
!  NJ 192:
!  INTEGER,PARAMETER :: NI=24,  NJ=192, NK=256,ngrid=4, maxout =1510532,maxint =1347840,int1=1179648
!  INTEGER,PARAMETER :: NI=12,  NJ=192, NK=256,ngrid=3, maxout = 819148,maxint = 672768,int1= 589824
! =====================================================================================================     
!  NJ 176:
   INTEGER,PARAMETER :: NI=12,  NJ=176, NK=256,ngrid=3, maxout =751716, maxint =616704, int1=540672
!  INTEGER,PARAMETER :: NI=24,  NJ=176, NK=256,ngrid=4, maxout =1386192,maxint =1235520,int1=1081344
!! INTEGER,PARAMETER :: NI=48,  NJ=176, NK=256,ngrid=5, maxout =2650602,maxint =2471568,int1=2162688
! =====================================================================================================     
!  Others:
!  INTEGER,PARAMETER :: NI=16,  NJ=128, NK=256,ngrid=4, maxout =705432, maxint =599040, int1=524288
!  INTEGER,PARAMETER :: NI=16,  NJ=96,  NK=400,ngrid=4, maxout =828952, maxint =702000, int1=614400
! =====================================================================================================     
!  NI:
!  INTEGER,PARAMETER :: NI=48,  NJ=96,  NK=128,ngrid=5, maxout =737592, maxint =674064, int1=589824   
!  INTEGER,PARAMETER :: NI=48,  NJ=192, NK=128,ngrid=5, maxout =1457412,maxint =1348128,int1=1179648   
!  INTEGER,PARAMETER :: NI=48,  NJ=192, NK=256,ngrid=5, maxout =2888372,maxint =2696256,int1=2359296
!  INTEGER,PARAMETER :: NI=48,  NJ=192, NK=512,ngrid=5, maxout =5750292,maxint =5392512,int1=4718592
!
