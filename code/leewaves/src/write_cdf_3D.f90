subroutine write_cdf_3D(stepl,n)
   ...
   USE header, only : NI,NJ,NK,xc,yc,zc,p,h,consump,T,s,rho,Tr,u,v,w,vor,pv,uf,vf,wf,Kz,conv,con100,nconsume,dirout,rc_kind,ntr,&
                      zf,Jac,UL,WL,LEN,DL,& ! drpy,drpx,&
                      term_advcT, term_advcU, term_advcV, term_advcW, term_restT, term_restU,& !!! ADDED
...
!    REAL(kind=rc_kind) :: Trwrite(0:NI+1,0:NJ+1,0:NK+1,ntr)
   ...
   integer :: idvptc,idvJac,idvptfx,idvptfy,idvptfz!,idvdum1,idvdum2,idvdum3,idvfdiv      !! ADDED
   ...
   integer :: idvdrpy, idvdrpx,idvugeo,idvvgeo,idvzf
