...
!== LOCAL VARIABLES ===
 ...
 REAL(kind=rc_kind) ::  x0, y0, z0, x1, y1, z1
 REAL(kind=rc_kind) ::  dse, dsw, dsn, dss, dsu, dsd
 REAL(kind=rc_kind) ::  ds, dsmin, dsc
 REAL(kind=rc_kind) ::  rlon,rlat
 REAL(kind=rc_kind) ::  tt, dt, t0, ts
 REAL(kind=rc_kind) ::  dxyz, subvol, dtreg
 REAL(kind=rc_kind) ::  ss0, rr, rb, rg, rbg, uu

 INTEGER                                    :: landError=0 ,boundError=0
 REAL(kind=rc_kind) :: zz
